...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//0
            // TODO(student): Complete the vertices data for the cube mesh

            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//1
    ...
    vector<VertexFormat> vertices
    {
        VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0.5f, 0.2f)),
        VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.5f, 0, 1)),
        VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.3f, 0.5f, 0.6f), glm::vec3(0.5f, 0.5f, 0.2f)),
        VertexFormat(glm::vec3(0.5f, 1, 0.5),  glm::vec3(0.5f, 0.5f, 0.2f))
    };
    ...
    CreateMesh("myTetrahedron", vertices, indices);
    ...
    // Special Square
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), glm::vec3(0.5f, 0.5f, 0.2f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.3f, 0.5f, 0.6f), glm::vec3(0.5f, 0.5f, 0.2f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.3f, 0.5f, 0.6f), glm::vec3(0.5f, 0.5f, 0.2f)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 1, 1), glm::vec3(0.5f, 0.5f, 0.2f))
        };
        ...
        CreateMesh("specialSquare", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.5, 0, -1.25f), glm::vec3(1));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["myTetrahedron"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1.5f));
    // TODO(student): Draw the square
    RenderMesh(meshes["specialSquare"], shaders["VertexColor"], glm::vec3(-2, 0, 0.5f), glm::vec3(1));

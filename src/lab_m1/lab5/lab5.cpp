...
void Lab5::Update(float deltaTimeSeconds)
{
...

    {
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-2, 3, -3));
...
void Lab5::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        if (window->KeyHold(GLFW_KEY_O)) {
            ...
            projectionMatrix = glm::ortho(-5.0, 5.0, -5.0, 5.0, 0.01,1000.0);
        }
        ...
        if (window->KeyHold(GLFW_KEY_K)) {
            ...
            left += deltaTime;
            right -= deltaTime;
            projectionMatrix = glm::ortho(left, right, -5.0f, 5.0f, 0.01f, 1000.0f);
        }
